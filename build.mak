export PJDIR := /mnt/d/pjlib/pjproject-2.10
...
export TARGET_NAME := i686-pc-linux-android
...
export APP_CXXFLAGS :=  -fno-exceptions -fno-rtti -fexceptions -frtti   $(APP_CFLAGS)
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	 -lgcc -Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libgcc_real.a -latomic -Wl,--exclude-libs,libatomic.a -target i686-none-linux-android16 -no-canonical-prefixes -Wl,--build-id -nostdlib++ -Wl,--no-undefined -Wl,--fatal-warnings -lc -lm  
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lm  /mnt/d/ndk/linux/android-ndk-r21d/sources/cxx-stl/llvm-libc++/libs/x86/libc++_shared.so -lOpenSLES -llog -lGLESv2 -lEGL -landroid
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1  -target i686-none-linux-android16 -fdata-sections -ffunction-sections -funwind-tables -no-canonical-prefixes --sysroot /mnt/d/ndk/linux/android-ndk-r21d/toolchains/llvm/prebuilt/linux-x86_64/sysroot -Wno-invalid-command-line-argument -Wno-unused-command-line-argument -D_FORTIFY_SOURCE=2 -fPIC -I/mnt/d/ndk/linux/android-ndk-r21d/sources/cxx-stl/llvm-libc++/include -I/mnt/d/ndk/linux/android-ndk-r21d/sources/cxx-stl/llvm-libc++/../llvm-libc++abi/include -Ijni -DANDROID -nostdinc++ -Wformat -Werror=format-security -mstackrealign   -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
export PJ_INSTALL_CXXFLAGS :=  -fno-exceptions -fno-rtti -fexceptions -frtti   $(PJ_INSTALL_CFLAGS)
