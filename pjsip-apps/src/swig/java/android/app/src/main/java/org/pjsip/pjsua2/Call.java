...
public class Call {
  ...
  public my_call_data call_init_tonegen() {
    long cPtr = pjsua2JNI.Call_call_init_tonegen(swigCPtr, this);
    return (cPtr == 0) ? null : new my_call_data(cPtr, false);
  }

  public void call_play_digit_inband(String digits) {
    pjsua2JNI.Call_call_play_digit_inband(swigCPtr, this, digits);
  }

  public void call_deinit_tonegen() {
    pjsua2JNI.Call_call_deinit_tonegen(swigCPtr, this);
  }
